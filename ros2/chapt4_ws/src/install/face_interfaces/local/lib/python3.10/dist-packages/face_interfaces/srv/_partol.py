...
class Metaclass_Partol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from face_interfaces.srv import _partol
...
class Partol(metaclass=Metaclass_Partol):
    from face_interfaces.srv._partol import Partol_Request as Request
    from face_interfaces.srv._partol import Partol_Response as Response
