...
class Metaclass_FaceDetector_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('face_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'face_interfaces.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from face_interfaces.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from face_interfaces.srv._face_detector import FaceDetector_Request as Request
    from face_interfaces.srv._face_detector import FaceDetector_Response as Response
